...
\end{gather*}
в начало координат к моменту $T$ и обеспечивал при этом минимальное значение $I(T,u)$. 
...
\begin{utv}
Любая траектория $z(t)$ системы \eqref{s22:linear} с управлением \eqref{s22:linear_feedback}, выходящая из точки $ z_0 $, достигает начала координат к моменту $T$. 
