...
\end{gather}
\todo[inline]{О Б С У Д И Т Ь.  В этом доказательстве $\frac{\partial f_2}{\partial x}$ и $\beta$ --- это многомерные линейные операторы, действующие из $\mathbb{R}^n$ в $\mathbb{R}^{n \times r}$ и выражения $\beta(t) \Delta x(t)$ это не умножение, а применение этого оператора к вектору. }
\hfill $\square$
