...
\begin{theorem}\label{sec1:th:small_control_convexity}
    Пусть выполнены Предположения \ref{sec1:as:right_hand_side_conditions_global} и \ref{sec1:as:right_hand_side_diff_lip}, а также пара  матриц $(A, B)$, соответствующая линеаризованной вдоль пары $\left( x(\cdot,0),0\right)   $ системе \eqref{sec1:common_nonlinear}, является управляемой.
...
\end{gather}
 ...
 Отсюда,
 \begin{gather*}
 	\varepsilon \leqslant \sqrt[\alpha]{\frac{K}{4 \mu^2  L_1^2}}.
 \end{gather*}
...
\end{gather}
 ...
 \begin{zam}
 	...
 	Однако, величина $\varepsilon_1$, полученная таким образом может оказаться очень осторожной.
