...
В этой работе определены условия, при которых опорные функции множеств достижимости непрерывно зависят от малого параметра. 
Автор также отметил, что непрерывная зависимость множества достижимости от параметра означает его выпуклость при малых значениях малого параметра, однако никаких доказательств этого факта не приведено. 
Более того, из непрерывности множества достижимости не следует их выпуклость.
\end{zam}
