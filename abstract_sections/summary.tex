...
\begin{definition}
	Множеством достижимости $\overline{G}(\varepsilon)$ системы \eqref{s2:nonlinear_with_output} по выходу $ y = C x $ будем называть множество всех выходов $ y(t_0+\varepsilon) $,
...
Из Теоремы \ref{s2:th:assimptotic_equality} следует, что множества достижимости 
