...
\fancyfoot[L]{\color{gray}\textbf{2024-03-24--14-17-23}} % Добавление текста в правый колонтитул
...
\newcommand{\frc}[2]{\scriptsize\raisebox{2pt}{$#1$}\big/\raisebox{-3pt}{$#2$}}    % a/b, a выше, b ниже
